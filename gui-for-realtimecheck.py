...
#                 access_status, attendee_name = check_access(data, "Data/ticket_data.xlsx")  # Get attendee name
#                 print(access_status)  # Print the access status
#                 show_access_message(access_status, attendee_name, on_next_button_click)  # Pass attendee name
#                 if access_status.startswith("Welcome"):  # Check if access is granted
#                     update_excel(data, "Data/ticket_data.xlsx")  # Update excel if access is granted
...
# def show_access_message(message, attendee_name, callback):
#     global access_window
#     if message.startswith("Welcome"):
#         message = f"Welcome {attendee_name}!!!"
#     access_window = AccessMessageWindow(message, callback)
#     access_window.run()
